    ...
    <div className="mx-auto max-w-3xl px-6 py-16 space-y-10">
      ...
      <section>
        ...
        <p>
          ...
          Louis.Ai platform. By using the Service, you agree not to misuse the platform or assist
          others in doing so.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Users may not upload, distribute, or process content that infringes on copyrights,
          trademarks, or other intellectual property rights without proper authorization.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Automated scraping, bulk extraction, or attempts to copy the platform&apos;s data or
          functionality are prohibited unless explicitly authorized.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Louis.Ai provides AI-powered tools to assist with document analysis and knowledge
          retrieval. Users may not use the platform to generate harmful, deceptive, or illegal
          content.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We may investigate violations of this Policy and take appropriate action, including
          suspending or terminating accounts that violate these rules.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Louis.Ai may update this Acceptable Use Policy periodically. Continued use of the Service
