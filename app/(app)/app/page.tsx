      ...
      <div className="rounded-3xl border bg-card p-6 shadow-sm">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex w-full flex-col gap-2 md:w-auto md:min-w-[260px]">
            ...
            <div className="text-center text-[11px] text-muted-foreground">Tip: Upload first → better answers immediately.</div>
          </div>
        </div>
      </div>
        ...
        <div className="rounded-3xl border bg-card p-6 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <div className="mt-1 text-sm text-muted-foreground">Do this once and your workspace becomes instantly useful.</div>
            </div>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            ...
            <div className="rounded-2xl border bg-background/40 p-4">
              ...
              <div className="mt-1 text-xs text-muted-foreground">SOPs, onboarding, proposals — Louis grounds internal answers in your uploads.</div>
              <div className="mt-3">
                <Link href="/app/docs" className="rounded-xl border px-3 py-2 text-sm hover:bg-accent">
                  Go to Docs
                </Link>
          ...
          <div className="mt-4 text-xs text-muted-foreground">
            Current: bots {stats?.bots_count ?? "—"} • docs {stats?.documents_count ?? "—"} • plan {stats?.plan ?? "—"}
          </div>
        </div>
      ) : null}
        ...
        {tabs.map((t) => (
          <button
            ...
            className={[
              ...
              tab === t.key ? "bg-accent text-foreground" : "text-muted-foreground hover:bg-accent hover:text-foreground",
            ].join(" ")}
          >
            {t.label}
          </button>
      ...
      {tab === "overview" ? (
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-3xl border bg-card p-5 shadow-sm">
            ...
            <div className="mt-2 text-sm text-muted-foreground">If your workspace is brand new, do this once and you’re flying.</div>
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="rounded-2xl border bg-background/40 p-4">
                ...
                <div className="mt-1 text-xs text-muted-foreground">Get docs-backed internal answers, plus general reasoning when appropriate.</div>
                <div className="mt-3">
                  <Link href="/app/chat" className="rounded-xl border px-3 py-2 text-sm hover:bg-accent">
                    Go to Chat
                  </Link>
        ...
        <div className="rounded-3xl border bg-card p-5 shadow-sm">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="mt-2 text-sm text-muted-foreground">View schedule reminders, extraction outcomes, and account notices.</div>
            </div>
          ...
          <div className="mt-4 rounded-2xl border bg-muted p-4 text-sm text-muted-foreground">Go to the full Notifications page.</div>
        </div>
      )}
    </div>
  );
